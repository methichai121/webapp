...
import Activitydetailteacher from './Activitydetailteacher';
import Activitydetailstudent from './Activitydetailstudent';
...
function App() {
  useEffect(() => {
    axios.get("http://localhost:5000/api/test")
      .then(res => {
        console.log("เชื่อมต่อ Backend สำเร็จ:", res.data);
      })
      .catch(err => {
  ...
  return (
    <Router>
      <Routes>
        ...
        <Route path="/activitydetailteacher/:id" element={<Activitydetailteacher />} />
        <Route path="/activitydetailstudent/:id" element={<Activitydetailstudent />} />
